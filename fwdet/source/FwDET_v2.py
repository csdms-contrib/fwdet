...
def main(ws_path, dem_path, extent_path, clip_dem='clipDEM', cost_raster=''):
    ...
    water_depth.save('water_depth_estimate')
    ...
    waterDepthFilter2.save('water_depth_estimate_filtered')
    print('Done')
...
if __name__ == '__main__':
    ...
    main(ws_path, dem_path, extent_path)

    stop = timeit.default_timer()
    print('start: '.format(start))
    print('End: '.format(stop))
    print('Run time: {} {}'.format((stop - start)/60, 'min'))
